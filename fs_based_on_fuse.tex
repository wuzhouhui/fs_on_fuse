...
\item
  ...
  \includegraphics[width=12cm]{./images/./creat_t4.png}
\end{itemize}
\item
  创建目录
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./mkdir_t1.png}
\item
  创建一个已存在的目录 \texttt{mkdir dir\_existed};\\
  \includegraphics[width=12cm]{./images/./mkdir_t2.png}
\end{itemize}
\item
  删除文件
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./rm_t1.png}
\item
  删除一个不存在的文件 \texttt{rm file\_not\_existed};\\
  \includegraphics[width=12cm]{./images/./rm_t2.png}
\item
  删除一个已存在的目录文件 \texttt{rm dir\_existed};\\
  \includegraphics[width=12cm]{./images/./rm_t3.png}
\end{itemize}
\item
  删除目录
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./rmdir_t1.png}
\item
  删除已存在的非空目录 \texttt{rmdir dir\_nonempty};\\
  \includegraphics[width=12cm]{./images/./rmdir_t2.png}
\item
  删除不存在的目录 \texttt{rmdir dir\_noexisted};\\
  \includegraphics[width=12cm]{./images/./rmdir_t3.png}
\end{itemize}
\item
  读文件
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./read_t1.png}
\item
  从偏移位置 3 读 4 个字节 \texttt{./read file\_existed 3 4};\\
  \includegraphics[width=12cm]{./images/./read_t2.png}
\item
  读一个目录文件 \texttt{./read dir\_existed 0 1};\\
  \includegraphics[width=12cm]{./images/./read_t3.png}
\end{itemize}
\item
  写文件
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./write_t1.png}
\item
  写一个不存在的文件 \texttt{./write file\_not\_existed 0 string};\\
  \includegraphics[width=12cm]{./images/./write_t2.png}
\item
    写一个目录文件 \texttt{./write dir\_existed 0 string};\\
  \includegraphics[width=12cm]{./images/./write_t3.png}
\item
  从文件的末尾写一个大小已达到上限的文件
  \texttt{./write bigest 8457216 string};\\
  \includegraphics[width=12cm]{./images/./write_t4.png}
\end{itemize}
\item
  写目录
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./write_dir_t1.png}
\item
  在一个已存在的目录中创建新目录项 \texttt{mkdir dir\_existed/dir};\\
  \includegraphics[width=12cm]{./images/./write_dir_t2.png}
\item
...
\item
  ...
  \includegraphics[width=12cm]{./images/./mv_t1.png}
\item
  源文件是文件, 目标不存在
...
\item
  ...
  \includegraphics[width=12cm]{./images/./mv_t7.png}
\item
  源文件是目录, 目标是源目录的子目录
  \texttt{./mv dir\_existed dir\_existed/sub};\\
  \includegraphics[width=12cm]{./images/./mv_t8.png}
\end{itemize}
\item
  极端条件测试
\begin{itemize}
\item
  ...
  \includegraphics[width=12cm]{./images/./name_too_long.png}
\item
...
\end{verbatim}
  ...
  \includegraphics[width=12cm]{./images/./exhausted_1.png}
\end{itemize}
