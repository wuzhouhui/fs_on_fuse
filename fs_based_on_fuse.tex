...
\includegraphics[width=15cm]{./images/./FUSE_structure.svg.png}
...
\includegraphics[width=15cm]{./images/./layout.png}
...
\includegraphics[width=15cm]{./images/./file_mode.png}
...
\subsubsection{\texttt{format} \textit{diskfile}}
\begin{itemize}
\item
  功能: 格式化一个文件系统
\item
...
\item
  ...
  \subsubsection{\texttt{int ufs\_rm\_entry(struct ufs\_minode *dir, const struct ufs\_dir\_entry *entry)}}
  \begin{itemize}
\item
  功能: 从指定的目录中移除指定的目录项;
\item
...
\item
  ...
  \subsubsection{\texttt{int ufs\_add\_entry(struct ufs\_minode *dir, const struct ufs\_dir\_entry *entry)}}
  \begin{itemize}
\item
  功能: 在指定的目录中新增一个目录项
\item
...
\subsubsection{\texttt{int creat(const char *path, mode\_t mode)}}
\begin{itemize}
\item
  功能: 创建一个新文件
\item
...
\item
  ...
  \end{itemize}
  \subsubsection{\texttt{int mkdir(const char *path, mode\_t mode)}}
  \begin{itemize}
\item
  功能: 创建一个空目录;
\item
...
\item
  ...
  \end{itemize}
  \subsubsection{\texttt{int readdir(const char *dirpath)}}
  \begin{itemize}
\item
  功能: 读某个目录中的所有项
\item
...
\item
  ...
  \subsubsection{\texttt{int unlink(const char *path)}}
  \begin{itemize}
\item
  功能: 删除一个目录项;
\item
...
\item
  ...
  \end{itemize}
  \end{itemize}
  \subsubsection{\texttt{int access(const char *path, int mode)}}
  \begin{itemize}
\item
...
\item
  ...
  \end{itemize}
  \end{itemize}
  \subsubsection{\texttt{int mknod(const char *path, mode\_t mode, dev\_t dev)}}
  \begin{itemize}
\item
  功能: 创建一个普通文件;
\item
...
\item
  ...
  \end{itemize}
  \subsubsection{\texttt{int statfs(const char *path, struct statvfs *stat)}}
  \begin{itemize}
\item
  功能: 获取文件系统的统计信息;
\item
...
\item
  ...
  \end{itemize}
  \end{itemize}
  \subsubsection{\texttt{int opendir(const char *path)}}
  \begin{itemize}
\item
  功能: 打开一个目录;
\item
...
\item
  ...
  \end{itemize}
  \end{itemize}
  \subsubsection{\texttt{int closedir(DIR *dirp)}}
  \begin{itemize}
\item
  功能: 关闭一个打开着的目录文件;
\item
...
\item
  ...
  \end{itemize}
  \end{itemize}
  \subsubsection{\texttt{int flush(const char *path)}}
  \begin{itemize}
\item
  功能: 冲洗文件;
\item
...
\item
  创建一个已存在的文件 \texttt{./creat file\_existed};\\
  \includegraphics[width=15cm]{./images/./creat_t4.png}
\end{itemize}
\item
  创建目录
\begin{itemize}
\item
  ...
  \includegraphics[width=15cm]{./images/./mkdir_t1.png}
\item
  创建一个已存在的目录 \texttt{mkdir dir\_existed};\\
  \includegraphics[width=15cm]{./images/./mkdir_t2.png}
\end{itemize}
\item
  删除文件
\begin{itemize}
\item
  ...
  \includegraphics[width=15cm]{./images/./rm_t1.png}
\item
  删除一个不存在的文件 \texttt{rm file\_not\_existed};\\
  \includegraphics[width=15cm]{./images/./rm_t2.png}
\item
  删除一个已存在的目录文件 \texttt{rm dir\_existed};\\
  \includegraphics[width=15cm]{./images/./rm_t3.png}
\end{itemize}
\item
  删除目录
\begin{itemize}
\item
  ...
  \includegraphics[width=15cm]{./images/./rmdir_t1.png}
\item
  删除已存在的非空目录 \texttt{rmdir dir\_nonempty};\\
  \includegraphics[width=15cm]{./images/./rmdir_t2.png}
\item
  删除不存在的目录 \texttt{rmdir dir\_noexisted};\\
  \includegraphics[width=15cm]{./images/./rmdir_t3.png}
\end{itemize}
\item
  读文件
\begin{itemize}
\item
  读一个不存在的文件 \texttt{./read file\_not\_existed 0 1};\\
  \includegraphics[width=15cm]{./images/./read_t1.png}
\item
  从偏移位置 3 读 4 个字节 \texttt{./read file\_existed 3 4};\\
  \includegraphics[width=15cm]{./images/./read_t2.png}
\item
  读一个目录文件 \texttt{./read dir\_existed 0 1};\\
  \includegraphics[width=15cm]{./images/./read_t3.png}
\end{itemize}
\item
  写文件
\begin{itemize}
\item
  在偏移位置 7 写 ``wzh'' \texttt{./write file\_existed 7 wzh};\\
  \includegraphics[width=15cm]{./images/./write_t1.png}
\item
  写一个不存在的文件 \texttt{./write file\_not\_existed 0 string};\\
  \includegraphics[width=15cm]{./images/./write_t2.png}
\item
    写一个目录文件 \texttt{./write dir\_existed 0 string};\\
  \includegraphics[width=15cm]{./images/./write_t3.png}
\item
  从文件的末尾写一个大小已达到上限的文件
  \texttt{./write bigest 8457216 string};\\
  \includegraphics[width=15cm]{./images/./write_t4.png}
\end{itemize}
\item
  写目录
\begin{itemize}
\item
  ...
  \includegraphics[width=15cm]{./images/./write_dir_t1.png}
\item
  在一个已存在的目录中创建新目录项 \texttt{mkdir dir\_existed/dir};\\
  \includegraphics[width=15cm]{./images/./write_dir_t2.png}
\item
...
\item
  ...
  \includegraphics[width=15cm]{./images/./mv_t5.png}
\item
  源文件是目录, 目标是空目录 \texttt{./mv dir\_existed dir\_empty};\\
  \includegraphics[width=15cm]{./images/./mv_t6.png}
\item
  源文件是目录, 目标是非空目录
  \texttt{./mv dir\_existed dir\_nonempty};\\
  \includegraphics[width=15cm]{./images/./mv_t7.png}
\item
  源文件是目录, 目标是源目录的子目录
  \texttt{./mv dir\_existed dir\_existed/sub};\\
  \includegraphics[width=15cm]{./images/./mv_t8.png}
\end{itemize}
\item
  极端条件测试
\begin{itemize}
\item
  创建一个名字过长的文件 \\
  \texttt{./creat llllllllllllllllllllllllllll};

  \includegraphics[width=15cm]{./images/./name_too_long.png}
\item
...
\end{verbatim}
  ...
  \includegraphics[width=15cm]{./images/./exhausted_1.png}
\end{itemize}
...
\end{verbatim}
  ...
  \includegraphics[width=15cm]{./images/./exhausted_2.png}
\end{itemize}
\end{itemize}
\end{document}
